...
import com.yxb.mall.service.ResourceService;
...
public class ResourceController extends BasicController {
    ...
    @ResponseBody
    public String ajaxResMenuTop(HttpSession session){
        String userIdCondition = String.valueOf(session.getAttribute("userIdCondition"));//用户id条件用来筛选对应角色找到对应菜单
        return resourceService.selectResMenuTop(userIdCondition);
    }
