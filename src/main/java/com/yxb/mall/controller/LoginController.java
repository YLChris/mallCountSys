...
import com.yxb.mall.architect.utils.CreateImageCode;
import com.yxb.mall.domain.bo.BussinessMsg;
import com.yxb.mall.service.RoleService;
    ...
    public BussinessMsg loginCheck(String username, String password,String code,HttpServletRequest request){
        ...
        try {
            ...
            if (currentUser.isAuthenticated()) {
                ...
                request.getSession().setAttribute("userIdCondition",getCurrentUser().getUserId());
